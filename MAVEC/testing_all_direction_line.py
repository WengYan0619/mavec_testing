...
def detect_initial_lanes(image, margin=20, min_pixels=50, trace_length=40, max_hypotheses=5):
    ...
    def calculate_confidence(points, edge):
        ...
        print(f"Length: {length_score}, Intensity: {avg_intensity}, Continuity: {continuity_score}, Curvature: {curvature_consistency}")
        return confidence
...
def apply_sliding_window(image, hypotheses):
    ...
    if not lanes and top_horizontal:
        ...
        if lane_fit is not None:
            ...
            print("Top Horizontal Lane Detected")
...
# Usage
lanes = process_image(r"C:\Users\wengy\Downloads\lane_change.png")